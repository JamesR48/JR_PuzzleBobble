...
public class ConditionalFieldAttribute : PropertyAttribute
{
    ...
    public ComparingType comparingType { get; private set; }
    ...
    public ConditionalFieldAttribute(string comparedPropertyName, object comparedValue, ComparingType comparingType = ComparingType.Equal, DisablingType disablingType = DisablingType.DontDraw)
    {
